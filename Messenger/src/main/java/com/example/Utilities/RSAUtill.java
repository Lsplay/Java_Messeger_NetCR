...
public class RSAUtill {
	...
	public static void main(String[] args)
			throws IllegalBlockSizeException, NoSuchPaddingException, BadPaddingException, InvalidKeyException {
		try {
			String encryptedString = Base64.getEncoder().encodeToString(encrypt("Hello my leg", publicKey));
			System.out.println(encryptedString);
			String decryptedString = RSAUtill.decrypt(encryptedString, privateKey);
